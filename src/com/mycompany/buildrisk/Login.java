...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/k0.jpg"))); // NOI18N
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        SUrl = "jdbc:MySQL://localhost:3306/minecraft";
        SUser = "root";
        SPass = "";
        int notFound = 0;
        try {
            ...
            if(notFound == 1 && Password.equals(passDb)){
                Main237 Main237Frame = new Main237();
                
                Main237Frame.setVisible(true);
                Main237Frame.pack();
                Main237Frame.setLocationRelativeTo(null); 
                this.dispose();
            }else{
